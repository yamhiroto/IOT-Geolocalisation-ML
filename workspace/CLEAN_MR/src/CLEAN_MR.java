    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < wordList.size(); i++) {
            ...
            try {
                ...
                ProcessBuilder processBuilder = new ProcessBuilder(SSH_COMMAND, USER_PREFIX + machineName, HOSTNAME_COMMAND);
                ...
                if (isConnected) {
                    while (folderExist(machineName)) {
                        ProcessBuilder processBuilder2 = new ProcessBuilder(SSH_COMMAND, USER_PREFIX + machineName, FOLDER_DELETION_COMMAND, FOLDER_PATH + FOLDER_NAME);
